    ...
    function NotificationAPI() {
        ...
        this.identifyUser = function (user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                hashedUserId = "" + crypto_1.createHmac('sha256', this.clientSecret)
                    .update(id)
                    .digest('base64');
                customAuthorization = 'Basic ' +
                    Buffer.from(this.clientId + ":" + id + ":" + hashedUserId).toString('base64');
                return [2, this.request('POST', "users/" + encodeURIComponent(id), userData, customAuthorization)];
            });
        }); };
        ...
        this.updateSchedule = function (trackingId, sendRequest) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request('PATCH', "schedule/" + trackingId, sendRequest)];
            });
        }); };
        this.deleteSchedule = function (trackingId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request('DELETE', "schedule/" + trackingId)];
            });
        }); };
