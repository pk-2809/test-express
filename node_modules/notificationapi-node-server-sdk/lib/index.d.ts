import { CreateSubNotificationRequest, DeleteSubNotificationRequest, InitConfiguration, RetractRequest, SendRequest, SetUserPreferencesRequest, User } from './interfaces';
...
declare class NotificationAPI {
    ...
    updateSchedule: (trackingId: string, sendRequest: Partial<SendRequest>) => Promise<AxiosResponse<any>>;
    deleteSchedule: (trackingId: string) => Promise<AxiosResponse<any>>;
    request: (method: Method, uri: string, data?: unknown, customAuthorization?: string | undefined) => Promise<AxiosResponse>;
}
